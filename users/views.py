...
def inbox(request):
    profile = request.user.profile
    messagesRequests = profile.recipient.all()
...
def viewMessage(request, pk):
    profile = request.user.profile
    messageRequested = profile.recipient.get(id=pk)
    if not messageRequested.is_read:
        messageRequested.is_read = True
        messageRequested.save()
